...
<div class="aside">
  ...
  <ul class="nav">
    ...
    <li<?php echo in_array($current_page, array('posts', 'post-new', 'categories')) ? ' class="active"' : '' ?>>
      <a href="#menu-posts"<?php echo in_array($current_page, array('posts', 'post-new', 'categories')) ? '' : ' class="collapsed"' ?> data-toggle="collapse">
        <i class="fa fa-thumb-tack"></i>文章<i class="fa fa-angle-right"></i>
      </a>
      <ul id="menu-posts" class="collapse<?php echo in_array($current_page, array('posts', 'post-new', 'categories')) ? ' in' : '' ?>">
